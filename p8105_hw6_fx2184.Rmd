...
* From this boxplot, the test model 2 has the lowest RMSE, followed by my model and test model 1 has the highest RMSE. Therefore, test model 1 is potentially the best model among these three models, which we could do some further investigation.
